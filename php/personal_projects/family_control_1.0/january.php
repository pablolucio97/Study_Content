...
<html>
    ...
    <ul id="slide-out" class="sidenav">
      ...
      <!--HOME-->
        ...
        <table class="striped centered white">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM profitsjan ORDER BY name_profit";
                    ...
                    <form action="php_action/update.php" method="POST">
                        ...
                        <button type="submit" name="btn-edit2jan" class="btn">Confirmar</button>
                        <br>
                    </form>
                    </div>
                  </div>
                      ...
                      <form action="php_action/delete.php" method="POST">
                          <input type="hidden" name="id" value="<?php echo $datas['id'];?>">
                          <button type="submit" name="btn-deletejanpro" class="btn red">Confirmar</button>
                          <a href="#!" 
            ...
            <div class="row">
                <div class='col s12 m6 push-m3 center'>
                    ...
                    <form action="php_action/create.php" method="POST">
                        ...
                        <button type="submit" name="btn-addjan1" class="btn">Adcionar</button>
                    </form>
                </div>
            </div>
            </div>
    ...
    <div class="row contaienr">
      ...
      <!--EXPENSES-->
        ...
        <tbody>
            <?php
            $sql = "SELECT * FROM billsjan ORDER BY item";
            $result = mysqli_query($connect, $sql);
            if (mysqli_num_rows($result) > 0):
          ...
          <tr>
              ...
              <i class="material-icons blue-text">delete</i></a></td>
                  ...
                  <div id="modal_delete<?php echo $datas['id'];?>" class="modal">
                      ...
                      <form action="php_action/delete.php" method="POST">
                          <input type="hidden" name="id" value="<?php echo $datas['id'];?>">
                          <button type="submit" name="btn-deletejan" class="btn red">Confirmar</button>
                          <a href="#!" 
                      class="modal-action modal-close waves-effect waves-green btn-flat green white-text">Cancelar</a>
                      </form>
            </div>
                  ...
                  <div class="row">
                      <div class='col s12 m6 push-m3 center'>
                          ...
                          <form action="php_action/update.php" method="POST">
                              ...
                              <button type="submit" name="btn-edit1jan" class="btn">Confirmar</button>
                          </form>
                      </div>
                  </div>
                  </div>
     ...
     <button class="datepicker btn"><i class="material-icons">date_range</i></button>
            ...
            <div class="row">
                <div class='col s12 m6 push-m3 center'>
                    ...
                    <form action="php_action/create.php" method="POST">
                        ...
                        <button type="submit" name="btn-addjan" class="btn">Adcionar</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="row container">
              ...
              <?php
              $resultSum = mysqli_query($connect, "SELECT sum(realized_cost) FROM billsjan");
              $lines = mysqli_num_rows($resultSum);
              while($lines = mysqli_fetch_array($resultSum)){
                $lines2 = str_replace(".", ",", $lines);
    ...
    //SUMING VALUES OF TWO DIFERENTS TABLES
             $resultSum = mysqli_query($connect, "SELECT (SUM(realized_profit) - (SELECT SUM(realized_cost) FROM billsjan))  FROM profitsjan");
             $lines = mysqli_num_rows($resultSum);
             while($lines = mysqli_fetch_array($resultSum)){
              $str = implode('', $lines);
              $str2 = substr($str, 0,7);
