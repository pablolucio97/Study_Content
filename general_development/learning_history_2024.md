...
``` 
- At working with third services that requires connection opnening on NestJS application, e.g: Prisma and RabbitMQ, always close the connection when the application finishes to aboid memory leak and related issues. Example:
```typescript
